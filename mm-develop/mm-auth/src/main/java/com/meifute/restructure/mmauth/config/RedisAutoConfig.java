...
import com.meifute.restructure.mmauth.util.RedisUtil;
...
public class RedisAutoConfig {
    ...
    public RedissonClient redissonClient() throws IOException {
       ...
       // spring.redis.redisson.cfg=classpath:redisson.yaml
        if (redissonProperties.getConfig() != null) {
            ...
            try {
                ...
                try {
                    ...
                    throw new IllegalArgumentException("Can't parse cfg", e1);
                }
            }
