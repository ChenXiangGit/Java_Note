...
import com.meifute.restructure.mmauth.config.security.MmRedisTokenStore;
...
/**
 * @author 作者 liuliang
 * @version 创建时间：2020年4月2日 下午2:18:54
 */
@Slf4j
@RestController
@Api(tags = "OAuth API")
...
//	@LogAnnotation(module = "auth-server", recordRequestParam = false)
	public void getUserTokenInfo(
			...
			@ApiParam(required = true, name = "client_id", value = "client_id") @RequestParam(value = "client_id") String clientId,
			@ApiParam(required = true, name = "client_secret", value = "client_secret") @RequestParam(value = "client_secret") String clientSecret,
...
//	@LogAnnotation(module = "auth-server", recordRequestParam = false)
	public void getClientTokenInfo(@ApiParam(required = true, name = "client_id", value = "client_id") @RequestParam(value = "client_id") String clientId,
								   @ApiParam(required = true, name = "client_secret", value = "client_secret") @RequestParam(value = "client_secret") String clientSecret,
