...
import com.meifute.restructure.mmauth.config.token.json.JacksonMapper;
import com.meifute.restructure.mmauth.config.token.json.JsonMapper;
...
public class RedisClientDetailsService extends JdbcClientDetailsService {
	...
	private static class ClientDetailsRowMapper implements RowMapper<ClientDetails> {
		private com.meifute.restructure.mmauth.config.token.json.JsonMapper mapper = createJsonMapper();
	...
	private static JsonMapper  createJsonMapper() {
		if (ClassUtils.isPresent("org.codehaus.jackson.map.ObjectMapper", null)) {
			...
			return new com.meifute.restructure.mmauth.config.token.json.Jackson2Mapper();
		}
		return new com.meifute.restructure.mmauth.config.token.json.NotSupportedJsonMapper();
	}
